#!/bin/sh
#
mkdir -p /dockerVol/guacamole/init
mkdir -p /dockerVol/guacamole/nginx/ssl
...
echo "done"
cp ./init/initdb.sql /dockerVol/guacamole/init
...
echo "done"
cp ./nginx/ssl/* /dockerVol/guacamole/nginx/ssl
